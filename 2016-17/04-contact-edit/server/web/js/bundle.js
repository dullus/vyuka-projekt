...
exports.addressDelete = undefined;

var _ajax = require('common/ajax');

var _addressList = require('address/addressList');
...
class AddressDelete {
     ...
     */
    _initElements() {
        this.element.confirm = (0, _jquery2.default)('#section-address__confirm');
        this.element.cancelButton = (0, _jquery2.default)('#section-address__delete-cancel');
        this.element.submitButton = (0, _jquery2.default)('#section-address__delete-submit');
    }
    ...
    _submit() {
        _ajax.ajax.delete(API_URL + this.id).then(result => this._submitSuccess()).catch(function (error) {
    ...
    _submitSuccess() {
        this.element.confirm.hide();
        _addressList.addressList.submit();
    }
}

let addressDelete = exports.addressDelete = new AddressDelete();

},{"address/addressList":6,"common/ajax":10,"jquery":1}],3:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.addressDetail = undefined;

var _addressEditFinal = require('address/addressEditFinal');
...
class AddressDetail {
     ...
     */
    _initElements() {
        this.element.list = (0, _jquery2.default)('main');
        this.element.closeButton = (0, _jquery2.default)('.contact-detail .popup__close');
        this.element.editButton = (0, _jquery2.default)('.contact-detail__edit');
        this.element.detail = (0, _jquery2.default)('#contact-detail');
    ...
    _initBindings() {
        ...
        this.element.editButton.on('click', e => {
            this.element.detail.hide();
            _addressEditFinal.addressEdit.edit(this._lastId);
        });
    }
    ...
    draw(id) {
        if (id !== null) {
            if (id !== this._lastId) {
                _ajax.ajax.get(API_URL + id).then(result => {
...
let addressDetail = exports.addressDetail = new AddressDetail();

},{"address/addressEditFinal":5,"common/ajax":10,"jquery":1}],4:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.addressEdit = undefined;

var _ViewEditForm = require('common/ViewEditForm');

var _FormItem = require('common/FormItem');

var _formErrors = require('common/formErrors');

var _ajax = require('common/ajax');

var _addressList = require('address/addressList');

var _addressDetail = require('address/addressDetail');
...
class AddressEdit extends _ViewEditForm.ViewEditForm {
    constructor() {
        super();
        this.element = {};
        ...
        this.items = {
            ...
            name: new _FormItem.FormItem({
                groupId: SECTION_ID,
                name: 'name',
                required: true,
                trim: true,
                validators: [['isMin', 2, 'Please provide a valid name'], ['isMax', 255, 'Please use 255 characters max']]
            })
        };
    }
    ...
    _initElements() {
        this.element.list = (0, _jquery2.default)('main');
        this.element.form = (0, _jquery2.default)(SECTION_SELECTOR);
        this.element.popup = (0, _jquery2.default)('#contact-edit');
        this.element.cancelButton = (0, _jquery2.default)('.contact-edit .popup__close');
        this.element.submitButton = (0, _jquery2.default)('.contact-edit__submit');
    }
    ...
    _initBindings() {
        this.element.submitButton.on('click', e => {
            ...
            this._hideErrors();
            if (errors.length) {
                _formErrors.formErrors.showErrors(errors, SECTION_SELECTOR, undefined, true);
            } else {
                _formErrors.formErrors.hideErrors(SECTION_SELECTOR, undefined, true);
                this._submit();
            }
        });
    ...
    edit(id = null) {
        ...
        if (id !== null) {
            this.mode = 'patch';
            _ajax.ajax.get(API_URL + id).then(result => this._updateValues(result));
        } else {
            this.mode = 'post';
    ...
    _updateValues(data) {
        for (var prop in data) {
            (0, _jquery2.default)(SECTION_SELECTOR + ' [name="' + prop + '"]').val(data[prop]);
        }
    }
    ...
    _submit() {
        ...
        switch (this.mode) {
            case 'post':
                _ajax.ajax.post(API_URL, data).then(result => this._submitSuccess()).catch(function (error) {
                    console.log('NotWritten');
                });
                break;
            case 'patch':
                _ajax.ajax.patch(API_URL + this._getValByKey(data, 'id'), data).then(result => this._submitSuccess()).catch(function (error) {
                    console.log('NotWritten');
                });
                break;
        }
    ...
    _submitSuccess() {
        _addressList.addressList.getList();
        _addressDetail.addressDetail.resetLastId();
        this.element.popup.hide();
        this.element.list.removeClass('blur');
    }
     ...
     */
    _hideErrors() {
        _formErrors.formErrors.hideErrors(SECTION_SELECTOR);
    }
...
let addressEdit = exports.addressEdit = new AddressEdit();

},{"address/addressDetail":3,"address/addressList":6,"common/FormItem":8,"common/ViewEditForm":9,"common/ajax":10,"common/formErrors":11,"jquery":1}],5:[function(require,module,exports){
'use strict';
...
class AddressEditFinal extends _ViewEditForm.ViewEditForm {
    constructor() {
        super();
        this.element = {};
        this.updateMode = null;
        ...
        this.items = {
            ...
            email: new _FormItem.FormItem({
                groupId: SECTION_ID,
                name: 'email',
                required: true,
                trim: true,
                validators: [['isMin', 1, 'Please complete email'], ['isMax', 255], ['isEmail', 'Please provide a valid email address']]
            }),
            homeworld: new _FormItem.FormItem({
                groupId: SECTION_ID,
                name: 'homeworld',
                required: false,
                trim: true,
                validators: [['isMin', 2, 'Please provide a valid homeworld'], ['isMax', 255, 'Please use 255 characters max']]
            }),
            species: new _FormItem.FormItem({
                groupId: SECTION_ID,
                name: 'species',
                required: false,
                trim: true,
                validators: [['isMin', 2, 'Please provide a valid species'], ['isMax', 255, 'Please use 255 characters max']]
            }),
            info: new _FormItem.FormItem({
                groupId: SECTION_ID,
                name: 'info',
                required: false,
                trim: true,
                validators: [['isMin', 2, 'Please provide a valid info'], ['isMax', 1024, 'Please use 1024 characters max']]
            })
        };
    }
...
let addressEdit = exports.addressEdit = new AddressEditFinal();

},{"address/addressDetail":3,"address/addressList":6,"common/FormItem":8,"common/ViewEditForm":9,"common/ajax":10,"common/formErrors":11,"jquery":1}],6:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.addressList = undefined;
...
class AddressList {
    ...
    init() {
        this.element.list = (0, _jquery2.default)('main');
        this.element.prototype = (0, _jquery2.default)('#prototype');
        this.getList();
    }
    ...
    _bindItem(element) {
        element.on('click', e => {
            _addressDetail.addressDetail.draw(e.currentTarget.dataset['id']);
        });
    }
     ...
     */
    getList() {
        _ajax.ajax.get(API_URL).then(result => {
...
let addressList = exports.addressList = new AddressList();

},{"address/addressDetail":3,"common/ajax":10,"jquery":1}],7:[function(require,module,exports){
'use strict';
...
class App {
   ...
   */
  init() {
    _addressList.addressList.init();
    _addressDetail.addressDetail.init();
    _addressEditFinal.addressEdit.init();
  }
}
// import {addressEdit} from 'address/addressEdit';
/**
...
},{"address/addressDetail":3,"address/addressEditFinal":5,"address/addressList":6}],8:[function(require,module,exports){
'use strict';
...
var _formaters = require('common/formaters');
...
class FormItem {
    ...
    constructor(config) {
        ...
        if (this.element === null && this.groupId !== null && this.name !== null) {
            this.element = (0, _jquery2.default)('#' + this.groupId + ' [name=' + this.name + ']');
    ...
    validate(required) {
        ...
        for (let i = 0; i < this.validators.length; i++) {
            ...
            out = _validators.validators[validator[0]].apply(_validators.validators, args);
    ...
    getFormatedValue() {
        ...
        if (Array.isArray(this.formater)) {
            ...
            return _formaters.formaters[formater].apply(_formaters.formaters, args);
        }
...
},{"common/formaters":12,"common/validators":13,"jquery":1}],9:[function(require,module,exports){
'use strict';
        ...
        for (let item in this.items) {
            if (this.items.hasOwnProperty(item)) {
                if (this.items[item].isChanged()) {
                    ...
                    this._copyToViewElement(this.element.viewWindow, dataAttribute, item, value);
                }
            }
        }
    }
...
exports.ViewEditForm = ViewEditForm;
...
class Ajax {
    ...
    _ajax(type, url, data) {
        return new Promise((resolve, reject) => {
            ...
            opts.data = data;
            return _jquery2.default.ajax(url, opts);
        });
    }
...
let ajax = exports.ajax = new Ajax();
...
class FormErrors {
    ...
    showErrors(errors, sectionId, finerSelector = undefined, noGlobal = false) {
        ...
        var $formErrors = (0, _jquery2.default)(sectionId + ' .' + FORM_ERROR_CLASS);
        ...
        try {
            for (let i = 0; i < errors.length; i++) {
                ...
                (0, _jquery2.default)(sectionId + ' [name="' + errors[i].field + '"]').addClass(ELEMENT_ERROR_CLASS);

                if (noGlobal !== true) {
                    $formErrors.append((0, _jquery2.default)('<li>').text(message));
                } else {
                    (0, _jquery2.default)(sectionId + ' [name="' + errors[i].field + '"].' + ELEMENT_ERROR_CLASS + ' ~ .' + ELEMENT_ERROR_LABEL_CLASS).text(message);
                }
            }
            ...
            if (noGlobal !== true) {
                ...
                labelEl = (0, _jquery2.default)(sectionId + ' label[for=' + errors[0].field + ']');
                if (typeof labelEl[0] === 'undefined') {
                    labelEl = (0, _jquery2.default)(sectionId + ' [name=' + errors[0].field + ']');
                }
    ...
    hideErrors(sectionId, finerSelector) {
        ...
        let $formErrors = (0, _jquery2.default)(sectionId + ' .' + FORM_ERROR_CLASS);
        let $elementErrors = (0, _jquery2.default)(sectionId + ' .' + ELEMENT_ERROR_CLASS);

        $elementErrors.map((index, item) => {
            (0, _jquery2.default)(item).removeClass(ELEMENT_ERROR_CLASS);
        });
    ...
    hideFormErrors(errorBoxElement) {
        ...
        if (typeof errorBoxElement === 'string') {
            $formErrors = (0, _jquery2.default)(errorBoxElement + ' .' + FORM_ERROR_CLASS);
        } else {
    ...
    showDefaultError(sectionId, finerSelector, noGlobal = false) {
        this.showErrors([{ message: 'Sorry, there has been a problem processing your request. Please try again later!' }], sectionId, finerSelector, noGlobal);
    }
...
let formErrors = exports.formErrors = new FormErrors();
...
let formaters = exports.formaters = new Formaters();
